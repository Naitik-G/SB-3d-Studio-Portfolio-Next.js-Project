      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "AboutPage",
            "name": "About MotionDev",
            "description": "Learn about MotionDev's journey and team",
            "url": "https://www.motiondev.xyz/about",
            "mainEntity": {
              "@type": "Organization",
              "name": "MotionDev",
              "description": "Professional 3D modeling and visualization studio",
              "foundingDate": "2020",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          <div>
            <p className="text-gray-400 leading-relaxed">
              MotionDev embarks on a transformative quest to empower businesses and creators in achieving their aspirations through stunning 3D visualization. We pave the path towards success by delivering high-quality 3D models, product renders, and immersive environments. Our dedicated team guides and supports you through a personalized journey, unlocking your creative potential. With MotionDev at your side, you'll conquer challenges and reach new horizons in 3D design.
            </p>
          </div>
        </div>
